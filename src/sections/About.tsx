...
export const About: React.FC = () => {
    return (
        <div className={styles.about}>
            ...
            <p>Songs titles like <i>The Cats Are Building Mouse Holes</i> and <i>Reset the Internet</i> or <i>K8tlyn (with an 8 in it)</i> foreshadow some serious lyrical clout.  </p>
